  ...
  return (
    <div className='flex gap-2 justify-around '>
      ...
      <div className='mx-8 md:flex-1'>
        ...
        <ul className=' my-3 w-full md:w-[85svw] md:grid grid-cols-4'>
          {albums.map((album) => (
            <li key={album.id} className='border p-2 rounded grid gap-2 hover:bg-gray-200 transition-transform transform-gpu  duration-500 ease-in-out my-2'>
